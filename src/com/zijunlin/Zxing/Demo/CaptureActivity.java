...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TitleLayout title=(TitleLayout)findViewById(R.id.title_scan);
		title.setTitleText("电表参数设置->扫码");
	...
	public void handleDecode(final Result obj, Bitmap barcode,String scnResult) {
