 ...
 */
public class MCNL_ZouZiTestFragment extends Fragment {
				...
				try {
					...
					if (zouziBean != null) {
						if (test_state) {
							...
							Log.e(TAG,"biaozhun:"+zouziBean.getBiaozhundianneng());
							/*
							Log.e(TAG,"qishi1:"+zouziBean.getQishi1());
							Log.e(TAG,"jieshu1:"+zouziBean.getJieshu1());
							Log.e(TAG,"shiji1:"+zouziBean.getShiji1());
							Log.e(TAG,"zouzi1:"+zouziBean.getWucha1());
							
							Log.e(TAG,"qishi2:"+zouziBean.getQishi2());
							Log.e(TAG,"jieshu2:"+zouziBean.getJieshu2());
							Log.e(TAG,"shiji2:"+zouziBean.getShiji2());
							Log.e(TAG,"zouzi2:"+zouziBean.getWucha2());
							
							Log.e(TAG,"qishi3:"+zouziBean.getQishi3());
							Log.e(TAG,"jieshu3:"+zouziBean.getJieshu3());
							Log.e(TAG,"shiji3:"+zouziBean.getShiji3());
							Log.e(TAG,"zouzi3:"+zouziBean.getWucha3());
							*/
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		title.setTitleText(String.format(getText(R.string.manual_validation_of_virtual_load_placeholder).toString(),getText(R.string.walk_test).toString()));
		...
		btn_jiaoyan_jieguo.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("zouzifangshi", iZouzifangshi);
		...
		sp_zouzifangshi.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				...
				if (iZouzifangshi == 0) {
					...
					lv_pulse.setVisibility(View.INVISIBLE);
					...
					lv_pulse.setVisibility(View.VISIBLE);
				}
			}
